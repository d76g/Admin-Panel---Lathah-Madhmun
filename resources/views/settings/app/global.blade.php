                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-100">
                            <div class="form-check width-100">
                                ...
                                <label class="col-5 control-label" for="restaurant_can_upload_story">{{ trans('lang.store_can_upload_story') }}</label>
                                <input type="checkbox" class="form-check-inline" id="auto_approve_restaurant">
                                <label class="col-5 control-label" for="auto_approve_restaurant">{{ trans('lang.auto_approve_store') }}</label>
                            </div>
                        </div>
