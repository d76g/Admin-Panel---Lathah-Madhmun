                        ...
                        <div class="d-flex top-title-right align-self-center">
                            ...
                            <div class="select-box pl-3">
                                ...
                                <select class="form-control cuisine_selector">
                                    ...
                                    <option value="" disabled selected>{{trans('lang.select_category')}}</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="card card-box-with-icon bg--1">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="box-icon ab"><img src="{{ asset('images/store_icon.png') }}"></span>
                                    ...
                                    <div class="card card-box-with-icon bg--5">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card-box-with-content">
                                                ...
                                                <p class="mb-0 small text-dark-2">{{trans('lang.active_stores')}}</p>

                                            </div>

                                            <span class="box-icon ab"><img src="{{ asset('images/active_store.png') }}"></span>
                                    ...
                                    <div class="card card-box-with-icon bg--8">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card-box-with-content">
                                                ...
                                                <p class="mb-0 small text-dark-2">{{trans('lang.inactive_stores')}}</p>

                                            </div>

                                            <span class="box-icon ab"><img src="{{ asset('images/inactive_store.png') }}"></span>
                                    ...
                                    <div class="card card-box-with-icon bg--6">
                                        ...
                                        <div class="card-body d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card-box-with-content">
                                                ...
                                                <p class="mb-0 small text-dark-2">{{trans('lang.new_joined_stores')}}</p>

                                            </div>

                                            <span class="box-icon ab"><img src="{{ asset('images/new_store.png') }}"></span>
                    ...
                    <div class="card border">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center border-0">
                            ...
                            <div class="card-header-title">
                                ...
                                <h3 class="text-dark-2 mb-2 h4">{{trans('lang.store_table')}}</h3>
                            ...
                            <div class="card-header-right d-flex align-items-center">
                                ...
                                <div class="card-header-btn mr-3">
                                    ...
                                    <a href="{!! route('stores.create') !!}" class="btn-primary btn rounded-full"><i class="mdi mdi-plus mr-2"></i>{{trans('lang.create_store')}}</a>
...
<script type="text/javascript">
    ...
    $('.cuisine_selector').select2({
        ...
        placeholder: "{{trans('lang.select_category')}}",
    ...
    $(document).ready(function() {
        ...
        var fieldConfig = {
            ...
            fileName: "{{trans('lang.store_table')}}",
    ...
    async function buildHTML(val) {
        ...
        var food_url = '{{route("stores.items",":id")}}';

        food_url = food_url.replace(":id", vendorId);

        var vendor_url = '{{route("stores.orders",":id")}}';
        ...
        actionHtml += `<span class="action-btn">
            ...
            <a href="${food_url}"><i class="mdi mdi-basket-fill" title="Products"></i></a>
            ...
            if (confirm("{{trans('lang.selected_delete_alert')}}")) {
                ...
                $('#storeTable .is_open:checked').each(function() {
                    ...
                    database.collection('users').doc(author).update({
                        ...
                        deleteDocumentWithImage('vendors', dataId, "photo", ['photos'])
    ...
    $(document).on("click", "a[name='vendor-delete']", function(e) {
        ...
        if (confirm("{{trans('lang.selected_delete_alert')}}")) {
            ...
            deleteDocumentWithImage('vendors', id, "photo", ['photos'])
