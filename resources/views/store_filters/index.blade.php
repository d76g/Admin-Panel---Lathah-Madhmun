    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor">{{trans('lang.store_filter')}}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                    <li class="breadcrumb-item active">{{trans('lang.store_filter')}}</li>
                </ol>
            </div>
            <div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                <li class="nav-item">
                                <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.store_filter_table')}}</a>
                                </li>
                                <li class="nav-item">
                                <a class="nav-link" href="{!! route('storeFilters.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.store_filter_create')}}</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                        <div id="users-table_filter" class="pull-right"><label>{{trans('lang.search_by')}}
                            ...
                            <div class="table-responsive m-t-10">
                                <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>{{ trans('lang.store_filter_name')}}</th>
                                            <th>{{trans('lang.store_filter_options')}}</th>
...
function buildHTML(snapshots){
    ...
    alldata.forEach((listval) => {
        var val=listval;
            ...
            newdate='';
            var id = val.id;
            var route1 =  '{{route("storeFilters.edit",":id")}}';
