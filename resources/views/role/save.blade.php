                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="approved-vendors-list" value="approve.vendors.list" name="approve_vendors[]" class="permission">
                                                            <label class="contol-label2" for="approved-vendors-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="approved-vendors-delete" value="approve.vendors.delete" name="approve_vendors[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="pending-vendors-list" value="pending.vendors.list" name="pending_vendors[]" class="permission">
                                                            <label class="contol-label2" for="pending-vendors-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="pending-vendors-delete" value="pending.vendors.delete" name="pending_vendors[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="restaurants-list" value="stores" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="restaurants-create" value="stores.create" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="restaurants-edit" value="stores.edit" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="restaurants-view" value="stores.view" name="restaurants[]" class="permission">
                                                            <label class=" control-label2" for="restaurants-view">{{ trans('lang.view') }}</label>
                                                            <input type="checkbox" id="restaurant-delete" value="store.delete" name="restaurant[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="driver-delete" value="driver.delete" name="driver[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="categories-create" value="categories.create" name="category[]" class="permission">
                                                            <label class=" control-label2" for="categories-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="categories-edit" value="categories.edit" name="category[]" class="permission">
                                                            <label class=" control-label2" for="categories-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="category-delete" value="category.delete" name="category[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="foods-list" value="items" name="foods[]" class="permission">
                                                            <label class=" control-label2" for="foods-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="foods-create" value="items.create" name="foods[]" class="permission">
                                                            <label class=" control-label2" for="foods-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="foods-edit" value="items.edit" name="foods[]" class="permission">
                                                            <label class=" control-label2" for="foods-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="foods-delete" value="items.delete" name="foods[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="attributes-list" value="attributes" name="item-attribute[]" class="permission">
                                                            <label class=" control-label2" for="attributes-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="attributes-create" value="attributes.create" name="item-attribute[]" class="permission">
                                                            <label class=" control-label2" for="attributes-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="attributes-edit" value="attributes.edit" name="item-attribute[]" class="permission">
                                                            <label class=" control-label2" for="attributes-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="attributes-delete" value="attributes.delete" name="attributes[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="reviewattributes-list" value="reviewattributes" name="review-attribute[]" class="permission">
                                                            <label class=" control-label2" for="reviewattributes-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="reviewattributes-create" value="reviewattributes.create" name="review-attribute[]" class="permission">
                                                            <label class=" control-label2" for="reviewattributes-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="reviewattributes-edit" value="reviewattributes.edit" name="review-attribute[]" class="permission">
                                                            <label class=" control-label2" for="reviewattributes-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="reviewattributes-delete" value="reviewattributes.delete" name="review-attribute[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="orders-print" value="vendors.orderprint" name="orders[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="cashback" value="cashback.list" name="cashback[]" class="permission">
                                                            <label class=" control-label2" for="cashback">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="cashback-create" value="cashback.create" name="cashback[]" class="permission">
                                                            <label class=" control-label2" for="cashback-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="cashback-edit" value="cashback.edit" name="cashback[]" class="permission">
                                                            <label class=" control-label2" for="cashback-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="cashback-delete" value="cashback.delete" name="cashback[]" class="permission">
                                                            <label class=" control-label2" for="cashback-delete">{{ trans('lang.delete') }}</label>
                                                            <input type="checkbox" id="cashback-redeem" value="cashback.redeem.list" name="cashback[]" class="permission">
                                                            <label class=" control-label2" for="cashback-redeem">{{ trans('lang.cashback_redeem') }}</label>
                                                            <input type="checkbox" id="cashback-redeem-del" value="cashback.redeem.delete" name="cashback[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="advertisements-listrequest" value="advertisements.request" name="advertisements-list[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <label class=" control-label2" for="dynamicnotification-save">{{ trans('lang.edit') }}</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="restaurant-payouts-list" value="storesPayouts" name="restaurant-payouts[]" class="permission">
                                                            <label class=" control-label2" for="restaurant-payouts-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="restaurant-payouts-create" value="storesPayouts.create" name="restaurant-payouts[]" class="permission">
                                                            <label class=" control-label2" for="restaurant-payouts-create">{{ trans('lang.create') }}</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="driver-payments-list" value="driver.driverpayments" name="driver-payments[]" class="permission">
                                                            <label class=" control-label2" for="driver-payments-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="driver-payments-delete" value="driver.driverpayments.delete" name="driver-payments[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="driver-payouts-list" value="driversPayouts" name="driver-payouts[]" class="permission">
                                                            <label class=" control-label2" for="driver-payouts-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="driver-payouts-create" value="driversPayouts.create" name="driver-payouts[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="wallet-transaction-list" value="walletstransaction" name="wallet-transaction[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="payout-request-driver" value="payoutRequests.drivers" name="payout-request[]" class="permission">
                                                            <label class=" control-label2" for="payout-request-driver">{{ trans('lang.driver') }}
                                                                {{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="payout-request-restaurant" value="payoutRequests.stores" name="payout-request[]" class="permission">
                                                            <label class=" control-label2" for="payout-request-restaurant">{{ trans('lang.store') }}
                                                                {{ trans('lang.list') }}</label>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="banners-create" value="setting.banners.create" name="banners[]" class="permission">
                                                            <label class=" control-label2" for="banners-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="banners-edit" value="setting.banners.edit" name="banners[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="language-list" value="settings.app.languages" name="language[]" class="permission">
                                                            <label class=" control-label2" for="language-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="language-create" value="settings.app.languages.create" name="language[]" class="permission">
                                                            <label class=" control-label2" for="language-create">{{ trans('lang.create') }}</label>
                                                            <input type="checkbox" id="language-edit" value="settings.app.languages.edit" name="language[]" class="permission">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="cashback-offer" value="setting.cashbackOffer" name="cashback-offer[]" class="permission">
