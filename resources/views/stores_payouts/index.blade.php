                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0">{{ trans('lang.stores_payout_plural') }}</h3>
                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4">{{ trans('lang.stores_payout_table') }}</h3>
                                    <p class="mb-0 text-dark-2">{{ trans('lang.store_payouts_table_text') }}</p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">
                                        <?php if ($id != '') { ?>
                                        <a class="btn-primary btn rounded-full" href="{!! route('storesPayouts.create') !!}/{{ $id }}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.stores_payout_create') }}</a>
                                        <?php } else { ?>
                                        <a class="btn-primary btn rounded-full" href="{!! route('storesPayouts.create') !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.stores_payout_create') }}</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            var fieldConfig = {
                columns: [{
                    ...
                    {
                        key: 'note',
                        header: "{{ trans('lang.stores_payout_note') }}"
                    },
                ],
                fileName: "{{ trans('lang.stores_payout_table') }}",
            };
        ...
        async function getStoreNameFunction(vendorId) {
            ...
            await database.collection('vendors').where('id', '==', vendorId).get().then(async function(snapshots) {
                if (!snapshots.empty) {
                    ...
                    $('.restaurantTitle').html('{{ trans('lang.stores_payout_plural') }} - ' + vendorName);
