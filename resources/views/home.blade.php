            ...
            <div class="card-body">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-box-with-icon bg--1" onclick="location.href='{!! route('stores') !!}'">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-box-with-icon bg--5" onclick="location.href='{!! route('orders') !!}'">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <span class="box-icon ab"><img src="{{ asset('images/totalorder.png') }}"></span>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-box-with-icon bg--24" onclick="location.href='{!! route('items') !!}'">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <span class="box-icon ab"><img src="{{ asset('images/item.png') }}"></span>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-box-with-icon bg--6" onclick="location.href='{!! route('users') !!}'">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <span class="box-icon ab"><img src="{{ asset('images/client.png') }}"></span>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-box-with-icon bg--15" onclick="location.href='{!! route('drivers') !!}'">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-center">
                                ...
                                <span class="box-icon ab"><img src="{{ asset('images/totaldriver.png') }}"></span>
