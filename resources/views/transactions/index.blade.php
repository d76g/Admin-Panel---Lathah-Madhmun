                        ...
                        <div class="menu-tab d-none storeMenuTab">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('stores.orders', $id) }}" id="tab_orders">{{ trans('lang.tab_orders') }}</a>

                                </li>

                                <li>

                                    <a href="{{ route('stores.coupons', $id) }}" id="tab_promos">{{ trans('lang.tab_promos') }}</a>

                                <li>

                                    <a href="{{ route('stores.payout', $id) }}" id="tab_payouts">{{ trans('lang.tab_payouts') }}</a>

                                </li>

                                <li>

                                    <a href="{{ route('payoutRequests.stores.view', $id) }}" id="payout_request">{{ trans('lang.tab_payout_request') }}</a>
    ...
    <script>
                ...
                username.get().then(async function(snapshots) {
                    ...
                    if (userDetail.role == "vendor") {
                        ...
                        database.collection('vendors').where('author', '==', userDetail.id).get().then(async function(snapshots) {
                            ...
                            document.getElementById('payout_request').href = `{{ route('payoutRequests.stores.view', ':id') }}`.replace(':id', vendorDetail.id);
        ...
        async function buildHTML(val) {
            ...
            if (val.payment_method) {
                ...
                } else if (val.payment_method == "RazorPay" || val.payment_method == "razorPay" || val.payment_method == "razorpay") {
                ...
                } else if (val.payment_method == "PayFast" || val.payment_method == "payFast" || val.payment_method == "payfast") {

                    image = '{{ asset('images/payfast.png') }}';

                    payment_method = '<img alt="image" src="' + image + '" >';

                } else if (val.payment_method == "PayStack" || val.payment_method == "payStack" || val.payment_method == "paystack") {

                    image = '{{ asset('images/paystack.png') }}';

                    payment_method = '<img alt="image" src="' + image + '" >';

                } else if (val.payment_method == "FlutterWave" || val.payment_method == "flutterWave" || val.payment_method == "flutterwave") {

                    image = '{{ asset('images/flutter_wave.png') }}';

                    payment_method = '<img alt="image" src="' + image + '" >';

                } else if (val.payment_method == "Mercado Pago" || val.payment_method == "mercado Pago" || val.payment_method == "mercado pago") {
