                        ...
                        <div class="card border">
                            <div class="card-header d-flex justify-content-between align-items-center border-0">
                                <div class="card-header-title">
                                    <h3 class="text-dark-2 mb-2 h4">{{ trans('lang.restaurant_disbursement') }}</h3>
                                    <p class="mb-0 text-dark-2">{{ trans('lang.disbursement_table_text') }}</p>
                                </div>
                                <div class="card-header-right d-flex align-items-center">
                                    <div class="card-header-btn mr-3">
                                         @if ($id == '')
                                            @if (request()->is('payoutRequests/stores'))
                                                <a class="btn-primary btn rounded-full" href="{!! url('storesPayouts/create') !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.store_payout_request') }}</a>
                                            @endif
                                            ...
                                            @endif
                                        @else
                                            @if (request()->is('payoutRequests/stores/'.$id))
                                                <a class="btn-primary btn rounded-full" href="{!! url('storesPayouts/create/'.$id) !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.store_payout_request') }}</a>
                                            @endif
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var fieldConfig = {
                ...
                fileName: "{{ trans('lang.payout_request') }}",
            };
        ...
        async function buildHTML(val) {
            ...
            html.push('<span class="dt-time">' + date + ' ' + time + '</span>');
             if (val.paymentStatus == 'Pending' || val.paymentStatus == 'In Process') {
                html.push('<td class="order_placed"><span class="badge badge-primary py-2 px-3">' + val.paymentStatus + '</span></td>');
            } else if (val.paymentStatus == 'Reject' || val.paymentStatus == 'Failed') {
                html.push('<td class="order_rejected"><span class="badge badge-danger py-2 px-3">' + val.paymentStatus + '</span></td>');
            } else if (val.paymentStatus == 'Success') {
                html.push('<td class="order_completed"><span class="badge badge-success py-2 px-3">' + val.paymentStatus + '</span></td>');
            } else {
                html.push('');
            }
