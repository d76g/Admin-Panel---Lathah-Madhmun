                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0">{{ trans('lang.driver_disbursement') }}</h3>
                                    ...
                                    <div class="card-header-btn mr-3">
                                        @if ($id == '')
                                            @if (request()->is('payoutRequests/stores'))
                                                <a class="btn-primary btn rounded-full" href="{!! url('storesPayouts/create') !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.restaurant_payout_request') }}</a>
                                            @endif
                                        ...
                                        @else
                                            @if (request()->is('payoutRequests/stores/' . $id))
                                                <a class="btn-primary btn rounded-full" href="{!! url('storesPayouts/create/' . $id) !!}"><i class="mdi mdi-plus mr-2"></i>{{ trans('lang.restaurant_payout_request') }}</a>
                                            @endif
