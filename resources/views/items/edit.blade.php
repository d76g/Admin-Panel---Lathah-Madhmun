        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('stores.items', $_GET['eid']) }}">{{ trans('lang.item_plural') }}</a>
                    </li>
                    <?php }else{ ?>
                    ...
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            ...
                            <div class="form-check width-100">
                                ...
                                <label class="col-3 control-label" for="food_publish">{{ trans('lang.item_publish') }}</label>
                            </div>
                            <div class="form-check width-100">
                            ...
                            <div class="form-check width-100">
                                ...
                                <label class="col-3 control-label" for="food_take_away_option">{{ trans('lang.item_take_away') }}</label>
                            </div>
                        </fieldset>
                        <fieldset>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            ref.get().then(async function(snapshots) {
                ...
                $('#food_restaurant').val(product.vendorID).trigger('change');
                $('#food_restaurant').data('category-to-select', product.categoryID);
        ...
        $("#food_restaurant").change(async function() {
            ...
            await database.collection('vendors').doc(restaurant).get().then(async function(snapshot) {
                if (snapshot.exists) {
                    ...
                    let categoryToSelect = $('#food_restaurant').data('category-to-select');
                    if (categoryToSelect) {
                        $('#food_category').val(categoryToSelect);
                        $('#food_restaurant').removeData('category-to-select');
                    }
                }
            })
            $("#attributes_div").show();
