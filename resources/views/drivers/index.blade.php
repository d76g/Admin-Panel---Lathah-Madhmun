        ...
        $(document).ready(function() {
            ...
            const table = $('#driverTable').DataTable({
                ...
                ajax: function(data, callback, settings) {
                    ...
                    ref.orderBy('createdAt', 'desc').get().then(async function(querySnapshot) {
                        ...
                        querySnapshot.forEach(function(doc) {
                            ...
                            if (!childData.hasOwnProperty('vendorID') || (childData.hasOwnProperty('vendorID') && childData.vendorID=='')) {
                        ...
                        paginatedRecords.forEach(function(childData) {
                            ...
                            var chatViewRoute = "{{ route('drivers.chat', ':id') }}".replace(':id', childData.id);
                            var unreadHtml = '';
                            records.push([
                ...
                columnDefs: [{
                    ...
                    {
                        orderable: false,
                        targets: (checkDeletePermission) ? [0, 4, 5, 6, 7, 8, 9] : [3, 4, 5, 6, 7, 8]
                    },
                ],
                "language": {
